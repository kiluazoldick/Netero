...
export default function ConditionsCTA() {
  return (
    <div className="bg-white dark:bg-black  rounded-2xl p-8 text-center">
      ...
      <p className="text-zinc-500 text-sm leading-relaxed mb-6 max-w-md mx-auto">
        Si vous avez des questions concernant ces conditions ou sur la manière
        dont nous gérons votre accès, n'hésitez pas à nous contacter.
      </p>
